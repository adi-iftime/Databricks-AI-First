...
| **Skills**     | [.cursor/skills/](.cursor/skills/)                                         | Reusable capability modules: top-level **`*.md`** (routing defaults) and optional **`<name>/SKILL.md`** workflow packs (see [`.cursor/skills/README.md`](.cursor/skills/README.md)).                                                                                                                                     |
...
- **Declaration:** Each planned task lists **required skills** as references under `.cursor/skills/`: either **module** files (e.g. `backend.md`, `testing.md`) for default orchestrator routing, or **pack** paths (e.g. `test-driven-development/SKILL.md`, `planning-and-task-breakdown/SKILL.md`) for expanded workflows—see [`.cursor/skills/README.md`](.cursor/skills/README.md) per [planning-rules.md](.cursor/rules/planning-rules.md).
